...
const TextArea = ({ Notice }) => {
  ...
  const { customCSS, setCustomCSS, addCustomCssHandler } = useCustomCss(
    state,
    setState,
    selectedElement
  );
  ...
  const handleAlignment = (event, newAlignment) => {
    ...
    if (myInput2) {
      ...
      switch (value) {
        case "left":
          myInput2.style.justifyContent = "left";
          break;
        case "center":
          myInput2.style.justifyContent = "center";
          break;
        case "right":
          myInput2.style.justifyContent = "right";
      ...
      switch (value) {
        case "left":
          myInput1.style.justifyContent = "left";
          break;
        case "center":
          myInput1.style.justifyContent = "center";
          break;
        case "right":
          myInput1.style.justifyContent = "right";
      ...
      switch (value) {
        case "left":
          myInput.style.justifyContent = "left";
          break;
        case "center":
          myInput.style.justifyContent = "center";
          break;
        case "right":
          myInput.style.justifyContent = "right";
  ...
  const inputEvent = (event) => {
    ...
    if (key in state && Array.isArray(state[key].children)) {
      ...
      if (index !== -1) {
        ...
        switch (name) {
          case "font-family": {
            const myInput = newHtmlContent.querySelector(".htmlContentParent");
            myInput.style.fontFamily = "cursive";
            console.log("jejejejejj", myInput);
            setState((prevState) => {
              const updatedChildren = [...prevState[key].children];
              updatedChildren[index] = {
                ...updatedChildren[index],
          ...
          case "lines":
            {
              ...
              console.log("LINES =>>>>>>>>>>>>>>>>>>>>>>>>>", value, myInput);
              myInput.rows = String(value);
              setSingleLineState((prevSingleLineState) => {
                const indexToFind = prevSingleLineState.findIndex(
                  (element) => element.id === idToFind
                );
                if (indexToFind !== -1) {
                  return [
                    ...
                    {
                      ...prevSingleLineState[indexToFind],
                      lines: value, // Update only the 'label' property
                    },
                    ...prevSingleLineState.slice(indexToFind + 1),
                  ];
                }
          ...
          case "gap":
            {
              const myInput =
                newHtmlContent.querySelector(".htmlContentParent");
              if (flexDirectionState === "column") {
                myInput.style.marginBottom = value / 4 + "rem"; // Use marginBottom for column layout
              } else {
                myInput.style.gap = value / 4 + "rem"; // Use gap for row layout
              }
