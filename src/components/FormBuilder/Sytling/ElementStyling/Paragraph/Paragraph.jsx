...
const Paragraph = ({ Notice }) => {
  ...
  const [paraContentState, setParaContentState] = useState(
    indexToFind === -1 ? "" : singleLineState[indexToFind].paraContent
  );
